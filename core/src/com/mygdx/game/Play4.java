...
public class Play4 implements Screen {
	...
	public void show() {
		...
		groundshape.createChain(new Vector2[] { new Vector2(-40,-30), new Vector2(-40,-4)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		...
		groundshape.createChain(new Vector2[] { new Vector2(-30, 30), new Vector2(-30,4)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		...
		groundshape.createChain(new Vector2[] { new Vector2(-20, -30), new Vector2(-20,-4)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		...
		groundshape.createChain(new Vector2[] { new Vector2(-10, 30), new Vector2(-10,4)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		...
		groundshape.createChain(new Vector2[] { new Vector2(0,-30), new Vector2(0,-4)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		...
		groundshape.createChain(new Vector2[] { new Vector2(41,0), new Vector2(48,0)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		fixturedef.shape = groundshape11;
		bwall7 = world.createBody(balldef);
		bwall7.createFixture(fixturedef);
		...
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		fixturedef.shape = groundshape12;
		bwall8 = world.createBody(balldef);
		bwall8.createFixture(fixturedef);
		...
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		fixturedef.shape = groundshape13;
		bwall9 = world.createBody(balldef);
		bwall9.createFixture(fixturedef);
		...
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		fixturedef.shape = groundshape14;
		bwall10 = world.createBody(balldef);
		bwall10.createFixture(fixturedef);
