...
public class Play implements Screen {
	...
	public void show() {
		...
		groundshape.createChain(new Vector2[] { new Vector2(-35,-10), new Vector2(-35,10)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		...
		groundshape.createChain(new Vector2[] { new Vector2(-20, 0), new Vector2(-20,20)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		...
		groundshape.createChain(new Vector2[] { new Vector2(-5, 0), new Vector2(-5,-20)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		...
		groundshape.createChain(new Vector2[] { new Vector2(10, 10), new Vector2(10,-10)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
		...
		groundshape.createChain(new Vector2[] { new Vector2(25,-30), new Vector2(25,-10)});
		fixturedef.friction = 0.5f;
		fixturedef.restitution = 0f;
							...
							if(contacts > 0) {
								for(Contact contact : world.getContactList()){
									...
									if(a.getBody().getType() == BodyType.KinematicBody || b.getBody().getType() == BodyType.KinematicBody) {
										soundintro.dispose();
										( (Game)Gdx.app.getApplicationListener()).setScreen(new Play2());
									}
